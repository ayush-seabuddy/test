...
const OnboardingScreens = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <View
        style={[styles.header, { marginTop: currentIndex === 0 ? 0 : "10%" }]}
      >
      ...
      <View style={styles.bottomSheet}>
            ...
            <>
              ...
              <Text
                style={[
                  ...
                  { color: "white", fontSize: 12, lineHeight: 25 },
                ]}
              >
                {companyDescription}
              </Text>
        ...
        <View style={styles.fixedButtonsContainer}>
          <TouchableOpacity
            ...
            style={[
              styles.nextButton,
              { marginBottom: currentIndex === 0 ? 25 : 0 },
            ]}
          >
            <Text style={styles.nextButtonText}>
              {currentIndex === screensData(t).length - 1
                ? t("common.getStarted")
                : t("common.next")}
            </Text>
          </TouchableOpacity>
