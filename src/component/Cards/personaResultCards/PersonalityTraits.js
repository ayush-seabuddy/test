  ...
  return (
    <View style={styles.personalTraits}>
      ...
      <View style={styles.frameParent}>
        ...
        >
          <Text style={styles.personalityTraits}>Personality Traits</Text>
          <TouchableOpacity
        ...
        {!isExpanded && (
          <Text style={styles.asAnIntj}>
            {Object.entries(data?.insights?.personality_traits || {})
        ...
        {isExpanded && (
          <View style={styles.frameGroupFlexBox}>
            {Object.entries(data?.insights?.personality_traits || {}).map(([heading, text]) => (
              <View key={heading} style={{ marginBottom: 10, width: '100%' }}>
                {isNaN(Number(heading)) ? (
