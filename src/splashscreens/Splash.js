...
import { View, StyleSheet, Image, Animated, Platform, Dimensions } from 'react-native';
  ...
  return (
    <AppContainer>
      ...
      <View style={styles.container}>
        ...
        >
          <Image source={ImagesAssets.splash_imag_headings} style={styles.logoImage} />
        </Animated.View>
        ...
        >
          <Image source={ImagesAssets.Captlogo} style={{ height: 160, width: 120 }} />
        </Animated.View>
