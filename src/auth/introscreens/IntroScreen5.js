      ...
      <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
        <View style={styles.content}>
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.titleText}>WELL-BEING CHALLENGES & GAMIFICATION</Text>
          </View>
        </View>
        ...
        <View style={styles.bottomCard}>
          ...
          >
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Well-being Challenges & Gamification</Text>
            ...
            <TouchableOpacity
              onPress={() => navigation.replace('Mbti')}
