      ...
      <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
        <View style={styles.content}>
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.titleText}>ACCESS TO A RICH RESOURCE LIBRARY</Text>
          </View>
        </View>
        ...
        <View style={styles.bottomCard}>
          ...
          >
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Access to a Rich Resource Library</Text>
            ...
            <TouchableOpacity
              onPress={() => navigation.replace('IntroScreen4')}
              style={styles.nextButton}
            >
              <Text style={styles.nextButtonText}>Next</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => navigation.replace('IntroScreen2')}
