...
const About = () => {
  ...
  const capitalize = useCallback(
    (str: string) => (str ? str.charAt(0).toUpperCase() + str.slice(1) : "N/A"),
    [],
  );
    ...
    >
          ...
          <View style={styles.headerCard}>
            <View style={styles.leaderboardRow}>
              ...
              <Image
                ...
                style={{ height: 30, width: 30, tintColor: Colors.lightGreen }}
              />
            </View>
          </View>
          <View style={styles.statsRow}>
            <View style={styles.statCard}>
              <View style={styles.statRow}>
                ...
                <Text style={styles.countTextOther}>
                  {userDetails?.groupActivityCount || "0"}
                </Text>
              </View>
            ...
            {combinedHobbies.map((item, index) => (
              <View
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      colorCombination[index % 4].backgroundColor,
                  },
                ]}
              >
                <Text
      ...
      {(userDetails?.bio ||
        ...
        <View style={styles.chipCard}>
          {userDetails?.bio && (
            <View style={styles.section}>
              <Text style={[styles.chipTitle, { fontSize: 16, marginTop: 10 }]}>
          ...
          {userDetails?.nationality && (
            ...
            >
              ...
              <Text style={styles.chipText}>
                {capitalize(userDetails.nationality)}
              </Text>
            </View>
          )}
          ...
          <View style={styles.containerText}>
            {userDetails?.shipName && (
              <View style={styles.row}>
                ...
                <Text style={styles.value}>
                  {capitalize(userDetails.shipName)}
                </Text>
              </View>
            )}
            {userDetails?.gender && (
            ...
            {userDetails?.ethnicity && (
              <View style={styles.row}>
                ...
                <Text style={styles.value}>
                  {capitalize(userDetails.ethnicity)}
                </Text>
              </View>
            )}
            {userDetails?.relationshipStatus && (
              <View style={styles.row}>
                ...
                <Text style={styles.value}>
                  {capitalize(userDetails.relationshipStatus)}
                </Text>
              </View>
            )}
            {userDetails?.religion && (
            ...
            {userDetails?.alcohol && (
              <View style={styles.row}>
                ...
                <Text style={styles.value}>
                  {capitalize(userDetails.alcohol)}
                </Text>
              </View>
            )}
            {userDetails?.healthCondition && (
              <View style={styles.row}>
                ...
                <Text style={styles.value}>
                  {capitalize(userDetails.healthCondition)}
                </Text>
              </View>
            )}
          </View>
