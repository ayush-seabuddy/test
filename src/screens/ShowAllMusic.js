...
import MusicCards from "../component/Cards/personaResultCards/MusicCards";
import LottieView from "lottie-react-native";
import CustomLottie from "../component/CustomLottie";
const { width, height } = Dimensions.get("window");

const ShowAllMusic = ({ navigation, route }) => {
  const Data = route.params.data;
  return (
    <>
      <View style={styles.container}>
        {/* Header */}
        <AnouncementDetailsHeader navigation={navigation} title={"All Music"} />
        ...
        >
          <View>
            {Data ? (
              <MusicCards navigation={navigation} data={Data?.MUSIC || {}} />
            ) : null}
          </View>
        </ScrollView>
