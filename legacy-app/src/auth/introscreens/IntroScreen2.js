      ...
      <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
        <View style={styles.content}>
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.titleText}>DAILY CHECK-INS & PROGRESS TRACKING</Text>
          </View>
        </View>
        ...
        <View style={styles.bottomCard}>
          ...
          >
            <View style={styles.cardContent}>
              <Text style={styles.cardTitle}>Daily Check-ins & Progress Tracking</Text>
            ...
            <TouchableOpacity
              onPress={() => navigation.replace('IntroScreen1')}
